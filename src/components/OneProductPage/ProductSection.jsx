...
import { getProductById } from 'services/dbApi';
...
export const ProductSection = () => {
  ...
  console.log(product);
  return (
    <section className="product-page__section section-product">
          ...
          {product && (
            <div className="section-product__text-block">
              ...
              <div className="basket-item__amount-block section-product__amount-block">
                ...
                <span className="basket-item__amount section-product__amount">
                  1
                </span>
                <button
                  onClick={() =>
              ...
              <div className="section-product__descr-block">
                <p className="section-product__description">
                  Embrace the evening with a soft, serene scent. Aromatic
                  English lavender nestles among a cocooning note of white musk
                  and night-blooming moonflowers.
                </p>
